...
def test_flies_example():
    ...
    assert aba_framework.get_content() == open("prototype/test_resources/flies_example_solution.pl").read()
...
def test_robber_example():
    ...
    prolog = set_up_abalearn(input)
    aba_framework = abalearn(prolog)
    assert aba_framework.get_content() == open("prototype/test_resources/robber_example_solution.pl").read()