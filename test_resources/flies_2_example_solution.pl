...
my_rule(r_20,flies(A),[plane(A),alpha2(A)]).
my_rule(r_27,c_alpha1(A),[penguin(A),alpha3(A)]).
my_rule(r_30,c_alpha2(A),[damaged(A)]).
my_rule(r_36,c_alpha3(A),[superpenguin(A)]).
